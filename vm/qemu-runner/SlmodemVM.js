 ...
 *   testing), creates the two Unix-domain sockets the deprecated modemd-shim once
 *   connects back into, and exposes a framed, event-based interface
 *   to callers (PjsipBackend, via the QemuVM subclass).
 *
...
class SlmodemVM extends EventEmitter {
   ...
   * @param {string} opts.shimPath       - DEPRECATED. Was the path to modemd-shim; ignored now.
