 ...
 * (see vm/ctrl/wire.h and vm/qemu-runner/wire.js for framing).
 *
 ...
 * config.modem['slmodemd-pjsip'].transport.{audioPort,controlPort}.
 */
    ...
    server.once('error', (err) => {
      ...
      if (err.code === 'EADDRINUSE') {
        reject(new Error(
          ...
          `Configure a different port in config.modem['slmodemd-pjsip'].transport ` +
